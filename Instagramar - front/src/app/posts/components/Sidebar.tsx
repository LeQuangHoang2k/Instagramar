...
export default function Sidebar(props: ISidebarProps) {
    ...
    return (
        ...
        <div className="post-side-bar w-1/5 h-full p-2 border-r border-r-gray-300 bg-red-400">
            ...
            <div className="w-full h-4/5">
                {sidebar.map((side, key) => {
                    return (
                        <Button onClick={() => showNotifications()} key={key} className='w-full flex justify-start h-[50px] mb-2 normal-case text-white'>
